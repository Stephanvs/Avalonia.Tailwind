...
namespace Avalonia.Tailwind.SourceGenerators;

[Generator]
public class TailwindAvaloniaStylesSourceGenerator : IIncrementalGenerator
{
  private const string Namespace = "Avalonia.Tailwind";
